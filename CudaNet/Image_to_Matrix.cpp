...
void matrix_fun(vector<vector<int>> &Matrix, int number_of_image)// Открывает картинку под номером %number_of_image% и записывает значение пикселя в %vector<vector<int>> Matrix%
{
	char lastname[10];
...
void Console_out_of_range(vector<vector<int>> &Matrix, int iterator)// Выводит изображения в консоль, пока i<iterator
{
